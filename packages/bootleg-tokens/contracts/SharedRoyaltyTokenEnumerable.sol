...
import "./ISharedRoyaltyTokenEnumerable.sol";
...
contract SharedRoyaltyTokenEnumerable is AbstractSharedRoyaltyToken, ISharedRoyaltyTokenEnumerable {
  ...
  */
  function tokenFranchisorsTotal(uint256 tokenId) public view returns (uint256 count) {
    return _tokens[tokenId].franchisors.length;
  }
